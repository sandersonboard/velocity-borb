...
const HELIOS = {
  ...
  walkthroughPlan: {
    ...
    sequence: [
      ...
      { id: 'W5', title: 'Entity-level controls walkthrough', controls: ['EL-001', 'EL-002', 'EL-003', 'EL-004'], attendees: ['CFO', 'General Counsel', 'Deloitte audit partner'], pbcs: ['Code of conduct attestation records', 'Audit committee meeting minutes (last 4 quarters)', 'Authority matrix'], targetWeeks: -36 },
